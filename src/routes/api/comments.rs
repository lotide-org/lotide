...
async fn route_unstable_comments_attachments_0_href_get(
    params: (CommentLocalID,),
    ctx: Arc<crate::RouteContext>,
    req: hyper::Request<hyper::Body>,
) -> Result<hyper::Response<hyper::Body>, crate::Error> {
    ...
    crate::RouteNode::new().with_child_parse::<CommentLocalID, _>(
        crate::RouteNode::new()
            ...
            .with_child(
                "attachments/0/href",
                crate::RouteNode::new()
                    .with_handler_async("GET", route_unstable_comments_attachments_0_href_get),
            )
            .with_child(
                "like",
                crate::RouteNode::new().with_handler_async("POST", route_unstable_comments_like),
            )
            .with_child(
                "likes",
                crate::RouteNode::new()
            ...
            .with_child(
                "unlike",
                crate::RouteNode::new().with_handler_async("POST", route_unstable_comments_unlike),
            )
            .with_child(
                "replies",
                crate::RouteNode::new()
